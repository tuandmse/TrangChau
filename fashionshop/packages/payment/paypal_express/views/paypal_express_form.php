...
<select name="SANDBOX" class="span3">
    <option
        value="1"<?php echo ((bool)$settings['SANDBOX']) ? ' selected="selected"' : ''; ?>><?php echo lang('test_mode'); ?></option>
    <option
        value="0"<?php echo ((bool)$settings['SANDBOX']) ? '' : ' selected="selected"'; ?>><?php echo lang('live_mode'); ?></option>
</select>
