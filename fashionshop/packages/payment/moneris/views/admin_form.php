...
<div class="row">
    <div class="span3">
        ...
        <select name="mode" class="span3">
            <option
                value="test" <?php echo ($settings['mode'] == 'test') ? 'selected="selected"' : ''; ?>><?php echo lang('test_mode'); ?></option>
            <option
                value="production" <?php echo ($settings['mode'] != 'production') ? '' : 'selected="selected"'; ?>><?php echo lang('production'); ?></option>
        </select>
    </div>
</div>
<div class="row">
