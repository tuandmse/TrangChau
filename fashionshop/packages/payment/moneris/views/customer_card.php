...
<div class="form_wrap">
    <div>
        ...
        <input name="first_name" type="text" class="pmt_required textfield input"
               value="<?php echo @$cc_data["first_name"] ?>" size="30"/>
    </div>
    <div>
        <?php echo lang('address_lastname') ?><b class="r"> *</b><br/>
        <input name="last_name" type="text" class="pmt_required textfield input"
               value="<?php echo @$cc_data["last_name"] ?>" size="30"/>
    </div>
</div>
<div class="form_wrap">
    <div>
        <?php echo lang('card_number') ?><b class="r"> *</b><br/>
        <input id="card_num" name="card_num" type="text" class="pmt_required textfield input"
               value="<?php echo @$cc_data["card_num"] ?>" size="30">
    </div>
    <div>
    ...
    <div>
        ...
        <input style="width:30px;" name="card_code" type="text" class="pmt_required textfield input" id="card_code"
               maxlength="4" value="<?php echo @$cc_data["card_code"] ?>"/>
    </div>
</div>
<br style="clear:both;">