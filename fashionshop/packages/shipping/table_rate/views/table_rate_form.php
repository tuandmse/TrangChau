<div class="row">
    <div class="span12">
        <select name="enabled" class="span3">
            <option
                value="1"<?php echo ((bool)$enabled) ? ' selected="selected"' : ''; ?>><?php echo lang('enabled'); ?></option>
            <option
                value="0"<?php echo ((bool)$enabled) ? '' : ' selected="selected"'; ?>><?php echo lang('disabled'); ?></option>
        </select>
            ...
            <div class="controls">
                <div class="input-append">
                    ...
                    <button class="btn" type="button"
                            onclick='add_new_table()'><?php echo lang('add_table'); ?></button>
                </div>
            </div>
        </div>
    </div>
...
<div id="kill_on_save">
    <div id="table_form_template" style="display:none">
        ...
        <li class="active" id="table_var_count">
            <button onclick="delete_table(var_count);" type="button" class="btn btn-danger pull-right"
                    style="margin-top:3px; margin-right:3px;"><i class="icon-trash icon-white"></i></button>
                                        ...
                                        <div class="span9">
                                            <div class="form-inline pull-right" style="margin:10px 0px;">
                                                ...
                                                <button type="button" class="btn"
                                                    ...
                                                    <i class="icon-plus-sign"></i> <?php echo lang('add_rate'); ?>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
    ...
    <table style="display:none;">
        ...
        <tr id="rate_var_count" class="form-inline">
            ...
            <td><input id="from_line_var_count" type="input" name="rate[var_table_count][rates][var_count][from]"
                       class="span1"/></td>
            <td><?php echo lang('rate'); ?> </td>
            <td><input id="rate_line_var_count" type="input" name="rate[var_table_count][rates][var_count][rate]"
                       class="span1"/></td>
            <td>
					<span class="pull-right">
						<button class="btn btn-danger" type="button" onclick="delete_rate(var_count)"><i
