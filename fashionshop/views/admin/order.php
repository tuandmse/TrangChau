<div class="row">
    <div class="span12">
        <div class="btn-group pull-right">
            ...
            <a class="btn" href="<?php echo site_url('admin/orders/packing_slip/' . $order->id); ?>" target="_blank"><i
                    class="icon-file"></i><?php echo lang('packing_slip'); ?></a>
        </div>
    </div>
</div>
...
<div class="row" style="margin-top:20px;">
    ...
    <div class="span4">
        ...
        <?php if (!empty($order->shipping_notes)): ?>
            <div style="margin-top:10px;"><?php echo $order->shipping_notes; ?></div><?php endif; ?>
    </div>
</div>
