...
<div id="notification_form" class="row">
    <div class="span12">
        ...
        <fieldset>
            ...
            <input type="text" name="recipient_show" size="40" id="recipient_name_show" class="span12" value="<?php echo $guestbook->name.' ('.$guestbook->email.')';?>" readonly/>
            <input type="hidden" name="recipient" size="40" id="recipient_name" class="span12" value="<?php echo $guestbook->email;?>"/>
