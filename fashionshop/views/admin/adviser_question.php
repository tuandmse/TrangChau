        ...
        <table class="table table-striped">
            ...
            <?php foreach($questions as $entry): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-small" style="float:right;"href="<?php echo site_url($this->config->item('admin_folder').'/adviser_question/form/'.$entry->questionNode);?>"><i class="icon-search"></i> <?php echo lang('form_view')?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
