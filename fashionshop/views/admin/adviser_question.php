<div class="row">
    <div class="span12">
        ...
        <div style="text-align:right">
            <a class="btn btn-primary" href="<?php echo site_url($this->config->item('admin_folder').'/adviser_question/form'); ?>"><i class="icon-plus-sign"></i> Thêm Câu Hỏi</a>
        </div>
        ...
        <table class="table table-striped">
            ...
            <?php foreach($questions as $entry): ?>
                <tr>
                    <td><input name="order[]" type="checkbox" value="<?php echo $entry->questionNode; ?>" class="gc_check"/></td>
                    ...
                    <td>
                        <a class="btn btn-small" style="float:right;"href="<?php echo site_url($this->config->item('admin_folder').'/adviser_question/form/'.$entry->questionNode);?>"><i class="icon-pencil"></i> <?php echo lang('form_view')?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
