...
function sort_url($lang, $by, $sort, $sorder, $admin_folder)
{
    ...
    $return = site_url($admin_folder . '/adviser_rule/index/' . $by . '/' . $sort);
    ...
    <div class="span12">
        ...
        <div style="text-align:right">
            <a class="btn btn-primary"
               href="<?php echo site_url($this->config->item('admin_folder') . '/adviser_rule/form'); ?>"><i
        ...
        <table class="table table-striped" style="float: left;">
            ...
            <?php foreach ($rules as $entry): ?>
                <tr>
                    <td><input name="order[]" type="checkbox" value="<?php echo $entry->rulesId; ?>" class="gc_check"/>
                    </td>
                    ...
                    <td>
                        <a class="btn btn-small" style="float:right;"
                           href="<?php echo site_url($this->config->item('admin_folder') . '/adviser_rule/form/' . $entry->rulesId); ?>"><i
