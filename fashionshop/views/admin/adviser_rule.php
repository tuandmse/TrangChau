<div class="row">
    <div class="span12">
        ...
        <div style="text-align:right">
            <a class="btn btn-primary" href="<?php echo site_url($this->config->item('admin_folder').'/adviser_rule/form'); ?>"><i class="icon-plus-sign"></i> Thêm Luật</a>
        </div>
        ...
        <table class="table table-striped">
            ...
            <?php foreach($rules as $entry): ?>
                <tr>
                    ...
                    <td>
                        <a class="btn btn-small" style="float:right;"href="<?php echo site_url($this->config->item('admin_folder').'/adviser_rule/form/'.$entry->rulesId);?>"><i class="icon-pencil"></i> <?php echo lang('form_view')?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
