                ...
                <div class="nav-collapse">
                    <ul class="nav">
                        ...
                        if (!$this->auth->check_access('Advisers')) : ?>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <!--                            <li><a href="-->
                                    <?php //echo $admin_url;?><!--coupons">-->
                                    <?php //echo lang('common_coupons') ?><!--</a></li>-->
                                    <!--                            <li><a href="-->
                                    <?php //echo $admin_url;?><!--giftcards">-->
                                    <?php //echo lang('common_giftcards') ?><!--</a></li>-->
                        ...
                        <?php endif; ?>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle"
                                   data-toggle="dropdown"><?php echo lang('common_catalog') ?> <b class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    <?php
                                    // Restrict access from Advisers
                                    if (!$this->auth->check_access('Advisers')) : ?>
                        ...
                        if (!$this->auth->check_access('Orders')) : ?>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Quản Trị Hệ Tư Vấn<b
                                        class="caret"></b></a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<?php echo $admin_url; ?>adviser_evaluation">Quản Trị Đánh Giá Tư
                                            Vấn</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        ...
                        <?php //echo lang('common_content') ?><!-- <b class="caret"></b></a>-->
                        <!--                        <ul class="dropdown-menu">-->
                        <!--                            <li><a href="--><?php //echo $admin_url;?><!--banners">-->
                        <?php //echo lang('common_banners') ?><!--</a></li>-->
                        <!--                            <li><a href="--><?php //echo $admin_url;?><!--pages">-->
                        <?php //echo lang('common_pages') ?><!--</a></li>-->
                        <!--                        </ul>-->
                        <!--                    </li>-->
                        <?php
                        ...
                        if ($this->auth->check_access('Admin')) : ?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <!--                            <li><a href="-->
                                    <?php //echo $admin_url;?><!--shipping">-->
                                    <?php //echo lang('common_shipping_modules') ?><!--</a></li>-->
                                    <li>
                                        <a href="<?php echo $admin_url; ?>payment"><?php echo lang('common_payment_modules') ?></a>
                                    </li>
                                    <!--                            <li><a href="-->
                                    <?php //echo $admin_url;?><!--settings/canned_messages">-->
                                    <?php //echo lang('common_canned_messages') ?><!--</a></li>-->
                                    <!--                            <li><a href="-->
                                    <?php //echo $admin_url;?><!--locations">-->
                                    <?php //echo lang('common_locations') ?><!--</a></li>-->
                                    <li>
