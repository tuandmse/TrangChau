...
<script type="text/javascript">
    ...
    $("#addMoreAnswer").click(function () {
        $(".answers").append("<div class='controls'><input type='hidden' name='nodesNode[]' value='' class='span1' placeholder='Nút'/>            <input type='text' name='nodesContent[]' value='' class='span6' placeholder='Nội Dung Nút'/></div>");
    });
</script>