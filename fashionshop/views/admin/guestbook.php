    ...
    <div class="span12">
        ...
        <table class="table table-striped">
            ...
            <?php foreach($entries as $entry): ?>
                <tr>
                    <td><input name="order[]" type="checkbox" value="<?php echo $entry->guestbook_id; ?>" class="gc_check"/></td>
                    ...
                    <td>
                        <a class="btn btn-small" style="float:right;"href="<?php echo site_url($this->config->item('admin_folder').'/guestbook/viewdetails/'.$entry->guestbook_id);?>"><i class="icon-search"></i> <?php echo lang('form_view')?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
