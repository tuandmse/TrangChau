<div class="row">
    <div class="span12">
        ...
        <div style="text-align:right">
            <a class="btn btn-primary" href="<?php echo site_url($this->config->item('admin_folder').'/adviser_cf/form'); ?>"><i class="icon-plus-sign"></i> Thêm Chỉ Số</a>
        </div>
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <th style="white-space:nowrap">Mã Chỉ Số</th>
                <th style="white-space:nowrap">Nội Dung</th>
                <th style="white-space:nowrap">Giá Trị</th>
                <th></th>
            </tr>
            </thead>

            <tbody>
            <?php echo (count($cfs) < 1)?'<tr><td style="text-align:center;" colspan="8">Chưa có nút nào!</td></tr>':''?>
            <?php foreach($cfs as $entry): ?>
                <tr>
                    <td><input name="order[]" type="checkbox" value="<?php echo $entry->cfId; ?>" class="gc_check"/></td>
                    ...
                    <td>
                        <a class="btn btn-small" style="float:right;"href="<?php echo site_url($this->config->item('admin_folder').'/adviser_cf/form/'.$entry->cfId);?>"><i class="icon-pencil"></i> <?php echo lang('form_view')?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
