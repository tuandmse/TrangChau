    ...
    <div class="row">
        ...
        <div class="span12" style="text-align:right;">
            ...
            <?php if (!$this->Customer_model->is_logged_in(false, false)): ?>
                <input class="btn btn-large" type="submit" onclick="$('#redirect_path').val('checkout/login');"
                       value="<?php echo lang('login'); ?>"/>
                <input class="btn btn-large" type="submit" onclick="$('#redirect_path').val('checkout/register');"
            ...
            <?php if ($this->Customer_model->is_logged_in(false, false) || !$this->config->item('require_login')): ?>
                <input class="btn btn-large btn-primary" type="submit" onclick="$('#redirect_path').val('checkout');"
