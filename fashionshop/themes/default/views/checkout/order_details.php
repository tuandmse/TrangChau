        ...
        <?php if ($this->go_cart->requires_shipping()): ?>
            <div class="span3">
                <a href="<?php echo site_url('checkout/shipping_address'); ?>"
                   class="btn btn-block"><?php echo lang('shipping_address_button'); ?></a>
            ...
            if (!empty($shipping_method) && !empty($shipping_method['method'])):?>
                <div class="span3">
                    <p><a href="<?php echo site_url('checkout/step_2'); ?>"
                          class="btn btn-block"><?php echo lang('shipping_method_button'); ?></a></p>
    ...
    <?php if (!empty($payment_method)): ?>
        <div class="span3">
            <p><a href="<?php echo site_url('checkout/step_3'); ?>"
                  class="btn btn-block"><?php echo lang('billing_method_button'); ?></a></p>
